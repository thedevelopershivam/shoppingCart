...
function LoginForm({
  ...
  return (
    <div
      className={`fixed top-0 left-0 h-full w-full justify-center bg-bgPrimary border-3 border-transparent backdrop-blur-md z-999999 p-6 overflow-y-auto vs ${display} `}
    >
      {/* <div
        ...
        <div className="w-full bg-white px-5 pt-2 pb-5 shadow-lg rounded m-auto">
          <form className="flex flex-col w-full gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span
                className="ml-auto text-sm cursor-pointer text-red-500 hover:text-blue-500"
